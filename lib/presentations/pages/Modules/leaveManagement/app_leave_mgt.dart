...
class _LeaveScreenState extends State<LeaveScreen>
  ...
  Future<void> _pickEndDate() async {
    ...
    if (startDate == null) {
      _warn("Please select start date first.");
      return;
    }
    final picked = await CommonDatePicker.pickDate(
      context: context,
  ...
  Future<void> _submitLeave() async {
    ...
    try {
      ...
      if (code == "SH") {
        ...
        _handleResponse(
          resp.data["ShortLeaveApplicationResult"]?.toString() ?? "",
        );
        return;
      }
                  ...
                  child: isAuthorizationScreen
                      ...
                      : FadeTransition(
                          ...
                          child: ListView.builder(
                            ...
                            itemCount: leaveStatusList.length,
                            itemBuilder: (_, i) =>
                                _leaveCard(leaveStatusList[i], isDark: isDark),
                          ),
                        ),
                ),
              ],
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (selectedLeaveDesc != null)
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(10),
                        border: Border.all(
                          color: DS.brandStart.withOpacity(0.25),
                        ),
                      ),
                      child: Text(
                        selectedLeaveDesc!,
                  ...
                  if (_shouldShowHalfDayDropdown(code))
                    _halfDayDropdown(isDark),
                  if (code == "OD" || code == "SH") _timePickers(isDark),
                  const SizedBox(height: 10),
      ...
      child: ListView.builder(
        ...
        itemBuilder: (_, i) {
          ...
          return Container(
            ...
            decoration: BoxDecoration(
              color: isDark ? DS.inputDark : color.withOpacity(0.08),
              borderRadius: BorderRadius.circular(12),
                  ...
                  Row(
                    children: [
                      Icon(
                        ...
                        color: isChosen ? DS.brandStart : Colors.grey,
                        size: 18,
                      ),
                      const SizedBox(width: 8),
                      Text(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (approvalReason.isNotEmpty)
                        Text(
                          approvalReason,
                          style: TextStyle(color: si.color, fontSize: 11),
                          maxLines: 1,
                          overflow: TextOverflow.ellipsis,
                        ),
                    ],
  ...
  Widget _leaveAuthorizationData({bool isDark = false}) {
    ...
    final filtered = users
        .where((item) => item["Status"] == statuses[selectedApprovalTab])
        .toList();
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          _authPill("Approved", 1, DS.green1, isDark),
